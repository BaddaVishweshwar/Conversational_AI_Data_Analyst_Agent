...
const Testimonials = () => {
    ...
    return (
        <section id="testimonials" className="py-32 bg-card relative">
            <div className="container mx-auto px-4">
                <div className="max-w-3xl mb-24">
                    <h2 className="text-4xl font-bold text-foreground mb-6 tracking-tight">Trusted by engineering teams.</h2>
                    ...
                    {testimonials.map((t, index) => (
                        ...
                        >
                            <div className="flex gap-1">
                                {[1, 2, 3, 4, 5].map((star) => (
                                    <svg key={star} className="w-4 h-4 text-foreground fill-current" viewBox="0 0 20 20">
                            ...
                            <div className="flex items-center gap-4 pt-4 border-t border-slate-50">
                                <div className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center font-bold text-foreground border border-border">
                                    {t.avatar}
                                </div>
                                <div>
